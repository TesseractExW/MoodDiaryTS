...
function Create(collectionName: string): IRefreshTokenModel {
	...
	return Mongoose.model<IRefreshTokenDocument, IRefreshTokenModel>(
		collectionName,
		RefreshTokenSchema
	);
}

const database = Create("refreshToken");

export { database, IRefreshToken, IRefreshTokenDocument, IRefreshTokenModel };
